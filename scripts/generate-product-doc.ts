    ...
    sections: [
      ...
      // ── MAIN CONTENT ──
      {
        children: [
          ...
          heading2("2.2 Scale & Performance"),
          ...
          heading2("2.3 Deployment Architecture"),
          para(
          ...
          // ────────────────────────────────────────
          heading1("3. User Roles & Access Control"),
          para(
          ...
          heading2("3.1 Information Segregation"),
          para(
          ...
          emptyLine(),
          heading3("3.1.1 API-Level Enforcement"),
          ...
          emptyLine(),
          heading3("3.1.2 UI-Level Enforcement"),
          ...
          emptyLine(),
          heading3("3.1.3 Status Display Mapping"),
          makeTable(
          ...
          // ────────────────────────────────────────
          heading1("4. Functional Modules"),

          // 4.1 Site Management
          heading2("4.1 Site Management"),
          para(
          ...
          heading3("4.1.1 Site Configuration"),
          ...
          heading3("4.2.2 Site-Role Assignments"),
          ...
          heading2("4.3 Configurable Approval Workflow"),
          para(
          ...
          heading3("4.3.1 Workflow Configuration"),
          ...
          heading3("4.3.2 Workflow Execution"),
          ...
          heading3("4.3.3 Workflow Examples"),
          ...
          heading3("4.4.2 Material Features"),
          ...
          heading3("4.5.2 Inventory Integration Points"),
          ...
          heading3("4.6.1 Indent Creation"),
          ...
          heading3("4.6.2 Auto-Generated Indent Number"),
          ...
          heading3("4.6.3 Indent Lifecycle"),
          makeTable(
          ...
          emptyLine(),
          heading3("4.6.4 Indent Detail View"),
          ...
          bullet("Active/inactive status"),
          heading3("4.7.2 Vendor Categories"),
          ...
          heading3("4.7.3 Vendor Management Access"),
          ...
          heading3("4.9.2 Quote Comparison"),
          ...
          heading3("4.11.2 GRN Confirmation"),
          ...
          heading3("4.11.3 GRN Detail View"),
          ...
          emptyLine(),
          heading2("6.2 Indent & Approval Entities"),
          makeTable(
            ["Model", "Description", "Key Fields"],
            [
          ...
          emptyLine(),
          heading2("6.3 Vendor & Procurement Entities"),
          makeTable(
            ["Model", "Description", "Key Fields"],
            [
          ...
          heading2("7.3 Inventory (2 endpoints)"),
          makeTable(
            ["Method", "Endpoint", "Description", "Access"],
            [
          ...
          heading2("7.4 RFQ & Quotes (6 endpoints)"),
          makeTable(
            ["Method", "Endpoint", "Description", "Access"],
            [
          ...
          heading2("7.5 Purchase Orders (3 endpoints)"),
          makeTable(
            ["Method", "Endpoint", "Description", "Access"],
            [
          ...
          heading2("7.6 Goods Receipt (4 endpoints)"),
          makeTable(
            ["Method", "Endpoint", "Description", "Access"],
            [
          ...
          heading2("7.7 Admin (11 endpoints)"),
          makeTable(
            ["Method", "Endpoint", "Description", "Access"],
            [
          ...
          // 9. SEED DATA
          // ────────────────────────────────────────
          heading1("9. Test Environment & Seed Data"),
          ...
          heading2("9.3 Test Materials (20)"),
          ...
          heading2("10.2 Local Development Setup"),
          ...
          heading2("10.3 Production Deployment (Vercel)"),
          ...
          heading2("10.4 Environment Variables"),
          makeTable(
          ...
          // ────────────────────────────────────────
          heading1("11. End-to-End Workflow Example"),
